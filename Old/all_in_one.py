...
from tailored_input import handle_user_searches
import openai
import requests
...
for category, articles in articles_by_category.items():
    for article in articles:
        ...
        # Print the headline and its summary
        ...
        if related_articles:
            ...
            # Print the topic and perspective summaries
            print(f"Topic Summary: {topic_summary}")
            print(f"Perspective Summaries: {perspective_summary}")
            ...
            headlines_by_category[category].append({
                ...
                'perspective_summary': perspective_summary.split('\n\n')
            })
...
for category, headlines in headlines_by_category.items():
    ...
    for headline_info in headlines:
        ...
        print(f"Perpsective 1 Summary: {headline_info['topic_summary']}")
        print(f"Perspective 2 Summary:\n{headline_info['perspective_summary']}\n")
