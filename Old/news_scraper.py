...
Description: 
    ...
    Next-step:
    Add more sophisticated user prompting via voice commands:
    "I want to learn about Israel-Hamas"
    "I want to start following soccer"
    "I'm covering NVIDIA's stock performance for my job"
"""
